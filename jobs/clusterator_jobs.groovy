...
job("clusterator-create") {
  ...
  parameters {
    ...
    stringParam('NUM_NODES', '3', 'Number of nodes in each cluster')
    stringParam('MACHINE_TYPE', 'n1-standard-1', 'Node type')
    stringParam('VERSION', '1.8.12', 'The version of kubernetes to use.')
  }
